    ...
    return (        
        <Formik
            initialValues={{
                ...
                def_rank: 12,
                down: 3,
                running_avg_drive_passing_yards: 10.4,
                zone: 'red',
                Under_two: 1,
                drive_pass_count: 8,
                month: 'September',
            ...
            validate={values => {
                ...
                if (values.running_avg_drive_passing_yards === '') {
                    errors.running_avg_drive_passing_yards = 'Please enter a number'
                }
                if (values.zone === '') {
                ...
                if (values.drive_pass_count === '') {
                    errors.drive_pass_count = 'Please enter a valid number'
                }
                if (values.month === '') {
            ...
            onSubmit={async (values, actions) => {
                ...
                let dict = {
                    ...
                    drive_pass_count: values.drive_pass_count,
                    ...
                    month: values.month,
                    running_avg_drive_passing_yards: parseFloat(values.running_avg_drive_passing_yards),
        ...
        <Form>
            <bs.Row className="mb-4">
                ...
                <bs.Col md="6">
                    ...
                    <Input title="Passing completion %" name="success_rate" type="number" min="0" max="1" step="0.01"/>
